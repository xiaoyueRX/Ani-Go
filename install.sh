...
if [ -z "$version" ]; then
  version="$(curl -fsSLI -o /dev/null -w '%{url_effective}' "https://mirror.ghproxy.com/https://github.com/$REPO/releases/latest" \
    | sed -n 's#.*/releases/tag/##p')"
fi
if [ -z "$version" ]; then
  version="$(curl -fsSL "https://mirror.ghproxy.com/https://api.github.com/repos/$REPO/releases/latest" \
...
url="https://mirror.ghproxy.com/https://github.com/$REPO/releases/download/$version/codegraph-${target}.tar.gz"
