...
// GetCollections TMDB 暂不支持同步收藏
func (p *TMDBProvider) GetCollections(ctx context.Context, username string) ([]core.Anime, error) {
	return nil, fmt.Errorf("TMDB provider does not support GetCollections")
}
